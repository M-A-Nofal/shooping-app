  ...
  return (
    <div className='categories'>
        <div className='col'>
            ...
            <button>
                <Link className="link" to="/products/men">Sale</Link>
            </button>
            </div>
            <div className='row'>
        ...
        <div className='col'>
            <div className='row'>
                ...
                <button>
                    <Link className="link" to="/products/children"> New Season</Link>
                </button>
            </div>
        </div>
        <div className='col col-l'>
            <div className='row'>
                ...
                <div className='col'>
                    <div className='row'>
                        ...
                        <button>
                            <Link className="link" to="/products/children">Kids</Link>
                        </button>
                    </div>
                </div>
            </div>
            <div className='row'>
                <img src="https://images.pexels.com/photos/1159670/pexels-photo-1159670.jpeg?auto=compress&cs=tinysrgb&w=1600" alt=""/>
                    <button>
                        <Link className="link" to="/products/women">Shoes</Link>
                    </button>
            </div>
        </div>
    </div>
